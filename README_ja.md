...
| Keyword Wolf | 質問ラウンド → 投票 | ウルフ以外の全員が投票する |
...
正体隠匿ゲームです。全員に秘密のキーワードが配られますが、ランダムに選ばれた1人（ウルフ）だけ少し違うキーワードを受け取ります。自分がどちらなのかは知らされません。

- キーワードは同梱の225ペアから選ぶか、自分でカスタムのペアを入力します。
- 各ラウンドで全員が質問し、他の参加者が回答します。ラウンドが2つ以上ある場合、最終ラウンドは1対1の尋問になり、各自が1人を指名して質問します。
- ウルフ以外の全員が、怪しいと思う相手に投票します。自分自身には投票できず、引き分けの選択肢は適用されません。
